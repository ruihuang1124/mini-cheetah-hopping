...
qJ_MC([2,5,8,11],:) = -qJ_MC([2,5,8,11],:);
qJd_MC([2,5,8,11],:) = -qJd_MC([2,5,8,11],:);
% Flip the sign for knee rotaiton
qJ_MC([3,6,9,12],:) = -qJ_MC([3,6,9,12],:);
qJd_MC([3,6,9,12],:) = -qJd_MC([3,6,9,12],:);
...
u_MC([1,4,7,10],:) = 0;
X_MC = [pos_MC; rpy_MC; qJ_MC; vel_MC; rpyrate_MC; qJd_MC];
traj_MC = traj_A1;
