classdef HybridKinoDyn < handle
    ...
    methods
        ...
        function [xnext,y] = dynamics(H, x,u,dt,ctact)
            xnext = hkinodyn(x, u, dt, ctact);
            y = 0;          
        end

        function [A,B,C,D] = dynamics_par(H, x, u, dt, ctact)
            [A,B] = hkinodyn_par(x, u, dt,ctact);
            C = 0;
            D = 0;
        end
