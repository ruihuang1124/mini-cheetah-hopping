...
robot = struct(...
    ...
    robot.abadLoc{2} = [robot.bodyLength, robot.bodyWidth, 0]'/2;      % FL
    robot.abadLoc{3} = [-robot.bodyLength, -robot.bodyWidth, 0]'/2;    % RR
    robot.abadLoc{4} = [-robot.bodyLength, robot.bodyWidth, 0]'/2;     % RL
           
    robot.hipLoc{1} = [0, -robot.abadLinkLength, 0]';    % FR
    robot.hipLoc{2} = [0, robot.abadLinkLength, 0]';     % FL
    robot.hipLoc{3} = [0, -robot.abadLinkLength, 0]';    % RR
    robot.hipLoc{4} = [0, robot.abadLinkLength, 0]';     % RL
    
    robot.kneeLoc = [0, 0, -robot.hipLinkLength]';
    
    robot.abadRotorLoc{1} = [0.125, -0.049, 0]';
    robot.abadRotorLoc{2} = [0.125, 0.049, 0]';
    robot.abadRotorLoc{3} = [-0.125, -0.049, 0]';
    robot.abadRotorLoc{4} = [-0.125, 0.049, 0]';
    
    robot.hipRotorLoc{1} = [0, -0.04, 0]';
    robot.hipRotorLoc{2} = [0, 0.04, 0]';
    robot.hipRotorLoc{3} = [0, -0.04, 0]';
    robot.hipRotorLoc{4} = [0, 0.04, 0]';
